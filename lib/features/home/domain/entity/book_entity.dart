...
class BookEntity {
  ...
  factory BookEntity.fromFirestore(DocumentSnapshot doc) {
    final data =
        doc.data()
  ...
  factory BookEntity.fromDocument(DocumentSnapshot doc) {
    return BookEntity(
      id: doc.id,
      title: doc['title'],
      author: doc['author'],
  ...
  factory BookEntity.fromJson(Map<String, dynamic> data) {
    return BookEntity(
